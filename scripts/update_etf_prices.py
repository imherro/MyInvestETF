...
def main() -> int:
    parser = argparse.ArgumentParser(description="Refresh local A-share daily price cache for etf chart overlays.")
    parser.add_argument("--code", action="append", help="ETF code such as 600519.SH. Can be repeated.")
