...
from myinvestetf.db import connect, init_db


def main() -> int:
    parser = argparse.ArgumentParser(description="Build one deterministic ETFResearchReport from structured inputs.")
    ...
    report = build_etf_report(input_data, trace_recorder=recorder)
